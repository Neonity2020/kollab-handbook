    ...
    <section id="tips" className="py-20 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-100 mb-3">高效使用技巧</h2>
          <p className="text-slate-400 max-w-xl mx-auto">这 6 条习惯决定你的 AI 工作效率天花板。</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {tips.map((tip) => (
            <div key={tip.title} className="p-5 bg-[#111827] border border-[#1f2d45] rounded-xl card-hover">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-slate-200 mb-2">{tip.title}</h3>
        ...
        <div className="mt-10 bg-[#111827] border border-[#1f2d45] rounded-xl overflow-hidden">
          <div className="px-5 py-3 border-b border-[#1f2d45]"><p className="text-xs font-medium text-slate-300">AI 辅助 vs 手动完成时间对比</p></div>
