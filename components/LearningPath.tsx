    ...
    <section id="learning-path" className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-10">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-100 mb-3">7天学习路径</h2>
          <p className="text-slate-400 max-w-xl mx-auto">按这个顺序来，7 天内从新手到高效用户。</p>
        </div>
        <div className="mb-8 p-4 bg-[#111827] border border-[#1f2d45] rounded-xl">
        ...
        <div className="space-y-4">
          {learningPath.map((phase) => {
            ...
            return (
              <div key={phase.day} className="bg-[#111827] border border-[#1f2d45] rounded-xl overflow-hidden">
                <div className="flex items-center justify-between px-5 py-3.5 border-b border-[#1f2d45] bg-[#0d1424]/40">
        ...
        <div className="mt-10 p-6 bg-blue-600/10 border border-blue-500/20 rounded-xl text-center">
          <h3 className="text-base font-semibold text-slate-200 mb-2">准备好开始了？</h3>
          <p className="text-sm text-slate-400 mb-4">打开 Kollab，发送你的第一条任务。第一步比看完所有文档更重要。</p>
          <a href="https://kollab.im" target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-lg transition-all hover:shadow-lg hover:shadow-blue-500/25">打开 Kollab</a>
        </div>
      </div>
    </section>
  );
